      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            If you’d like to learn more about me, please connect with me on <a link href ="https://www.linkedin.com/in/sayalitandel/" className="purple">Linkedin</a>. You can also follow me on social media at the handles listed below.
            <br/>
            </p>
        </blockquote>
      </Card.Body>
